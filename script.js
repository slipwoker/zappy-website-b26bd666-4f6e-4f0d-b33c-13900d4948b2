    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Urban Novus - אורבן נובוס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b26bd666-4f6e-4f0d-b33c-13900d4948b2',
                    name: data.name || '',
                    email: data.email || '',
